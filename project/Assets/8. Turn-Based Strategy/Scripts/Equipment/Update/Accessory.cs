...
namespace Sammoh.TurnBasedStrategy
{
    ...
    /// <summary>
    /// Represents a stat modifier applied by equipment.
    /// </summary>
    [System.Serializable]
    ...
    /// <summary>
    /// Defines the different types of stats that can be modified.
    /// </summary>
    ...
    {
        Flat,       // Adds the value directly
        Percentage  // Multiplies by (1 + value/100)
    }
}