...
//         private ModifierType newModifierType = ModifierType.Flat;
//
...
//                     Debug.LogError("CreateDefaultEquipment method is commented out in EquipmentDatabase");
...
//                     EditorGUILayout.LabelField($"Armor: {database.Armors.Count}");
...
//                     // new ScriptableObjectEquipment instead of Equipment to avoid constructor issues
//                     var tempEquipment = ScriptableObject.CreateInstance<Equipment>();
//                     tempEquipment.EquipmentName = equipmentName;
//                     tempEquipment.Description = description;
//                     tempEquipment.Slot = selectedSlot;
//                     tempEquipment.StatModifiers = modifiers.ToArray();
//                     
//                     // Show stat changes
...
//             equipment.StatModifiers = modifiers.ToArray();
//             equipment.name = equipmentName.Replace(" ", "_");
//             
//             // Add to database
