...
**Description**: Developed a tool that allows for easy selection of game objects in a scene with the ability to filter by different global data types. This project emphasizes data management and inventory.
